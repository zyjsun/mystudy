...
import { getInputChangeAction, getAddItem, delItem, getTodoList, initListAction, getInitList } from './store/actionCreators'
...
class toDoList extends Component {
  componentDidMount () {//生命周期
    ...
    //   })
    // const action = getTodoList()//action只能放对象
    // store.dispatch(action)//action是函数时，该函数内部就有dispatch参数
